...
(defsc Segment [this {:segment/keys [id words translations start text autopause? ui-reveal-state active]
  ...
  (fragment 
   ...
   (div
    {:classes [(when active "active") "segment-transcription-and-translation"]}
    (span :.transcription
          (ui-popup
           (merge
