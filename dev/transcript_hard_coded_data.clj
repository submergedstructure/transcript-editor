...
(def audio-url->transcript-data
  {"/audio_and_transcript/090C-DailyPolishStory-QA.mp3" {"id" "b9c8eb5d-b7f8-4ce9-ae33-b19317380165"},
   ...
   {"id" "a0f1cee2-b66a-4a7f-afd8-e6b362724c5d"
    ...
    "summary" (str "Mateusz Malina, world champion and record holder in freediving, discusses how freediving helps him manage emotions. In his talk, he explains the physiological response to stress, such as increased heart rate, and how the body's amygdala reacts instinctively. By holding his breath and submerging in water, Malina demonstrates how freediving reduces heart rate and brings mental calmness. This meditative aspect, he says, allows him to dive deep into his thoughts and emotions. Freediving, for him, is a journey of self-discovery, helping him confront and control his emotions in all aspects of life.")
    "summary-pl" (str "Mateusz Malina, wielokrotny mistrz i rekordzista świata we freedivingu, opowiada, jak nurkowanie swobodne pomaga mu zarządzać emocjami. W swoim wystąpieniu wyjaśnia, jak ciało reaguje na stres, zwiększając tętno, i jak ciało migdałowate działa instynktownie. Podczas demonstracji wstrzymywania oddechu i zanurzenia twarzy w wodzie pokazuje, jak freediving spowalnia tętno i wprowadza spokój umysłu. To medytacyjne doświadczenie pozwala mu zanurzać się w swoich myślach i emocjach. Freediving jest dla niego podróżą w głąb siebie, pomagającą mu mierzyć się z emocjami w różnych aspektach życia.")}
